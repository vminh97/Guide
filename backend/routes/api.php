...
Route::group(['prefix' => 'api/hastang'], function () {
...
Route::group(['prefix' => 'api/new'], function () {
...
Route::group(['prefix' => 'api/certificate'], function () {
...
Route::group(['prefix' => 'api/orderdetail'], function () {
...
Route::group(['prefix' => 'api/customer'], function () {
...
Route::group(['middleware' => ['web']], function () {
    Route::get('api/loginsocial/{provide}', 'SocialLogin');
    Route::get('api/loginsocial/{provide}/callback', 'SocialLogin@handerredirct');
});
